...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'customers', 'name', orm['quotes.customer:name'])
        ...
        # (to signature: django.db.models.fields.CharField(max_length=40))
        db.alter_column(u'customers', 'phone', orm['quotes.customer:phone'])

        # Changing field 'Customer.email'
        # (to signature: django.db.models.fields.CharField(max_length=160))
        db.alter_column(u'customers', 'email', orm['quotes.customer:email'])

        # Changing field 'Customer.email2'
        # (to signature: django.db.models.fields.CharField(max_length=160))
        db.alter_column(u'customers', 'email2', orm['quotes.customer:email2'])

        # Creating unique_together for [quote_number] on Quote.
        db.create_unique('quotes_quote', ['quote_number'])



    def backwards(self, orm):

        # Deleting unique_together for [quote_number] on Quote.
        db.delete_unique('quotes_quote', ['quote_number'])
