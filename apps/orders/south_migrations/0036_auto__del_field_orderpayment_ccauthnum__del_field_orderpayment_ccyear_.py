...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('orders_orderpayment', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['orders.Order']), keep_default=False)

        # Adding field 'OrderPayment.last_4'
        db.add_column('orders_orderpayment', 'last_4', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)
        ...
        db.add_column('orders_orderpayment', 'auth_num', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderPayment.user'
        db.add_column('orders_orderpayment', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'OrderPayment.ccauthnum'
        db.add_column('orders_orderpayment', 'ccauthnum', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderPayment.ccyear'
        db.add_column('orders_orderpayment', 'ccyear', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderPayment.cclast4'
        db.add_column('orders_orderpayment', 'cclast4', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'OrderPayment.employee'
        raise RuntimeError("Cannot reverse this migration. 'OrderPayment.employee' and its values cannot be restored.")

        # Adding field 'OrderPayment.ccmonth'
        db.add_column('orders_orderpayment', 'ccmonth', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'OrderPayment.order'
        db.delete_column('orders_orderpayment', 'order_id')

        # Deleting field 'OrderPayment.last_4'
        db.delete_column('orders_orderpayment', 'last_4')
        ...
        # Deleting field 'OrderPayment.auth_num'
        db.delete_column('orders_orderpayment', 'auth_num')

        # Deleting field 'OrderPayment.user'
        db.delete_column('orders_orderpayment', 'user_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 23, 14, 13, 53, 542620)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 23, 14, 13, 53, 542471)'}),
        ...
        'orders.orderpayment': {
            ...
            'comments': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'expiry_month': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'expiry_year': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'payment_method': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
