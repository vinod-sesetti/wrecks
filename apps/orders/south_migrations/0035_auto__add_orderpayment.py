...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_orderpayment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment_method', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('payment_terms', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('cclast4', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('ccmonth', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('ccyear', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('ccauthnum', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('orders', ['OrderPayment'])


    def backwards(self, orm):
        
        # Deleting model 'OrderPayment'
        db.delete_table('orders_orderpayment')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 21, 21, 24, 32, 143684)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 21, 21, 24, 32, 143533)'}),
