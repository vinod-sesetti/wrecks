...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.shipregn'
        db.alter_column('orders_importedorder', 'shipregn', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ImportedOrder.billregn'
        db.alter_column('orders_importedorder', 'billregn', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.shipregn'
        db.alter_column('orders_importedorder', 'shipregn', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'ImportedOrder.billregn'
        db.alter_column('orders_importedorder', 'billregn', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 20, 10, 56, 52, 21164)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 20, 10, 56, 52, 20975)'}),
        ...
        'orders.importedorder': {
            ...
            'taxcounty': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
