...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ImportedOrder.refsrc'
        db.alter_column('orders_importedorder', 'refsrc', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 20, 8, 28, 924954)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 20, 8, 28, 924764)'}),
