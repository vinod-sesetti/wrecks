...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.iagree'
        db.alter_column('orders_importedorder', 'iagree', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'ImportedOrder.billsame'
        db.alter_column('orders_importedorder', 'billsame', self.gf('django.db.models.fields.CharField')(max_length=3))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.iagree'
        db.alter_column('orders_importedorder', 'iagree', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'ImportedOrder.billsame'
        db.alter_column('orders_importedorder', 'billsame', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 18, 50, 49, 153335)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 18, 50, 49, 153054)'}),
