...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.source'
        db.add_column(u'orders', 'source', self.gf('django.db.models.fields.CharField')(default='website', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.source'
        db.delete_column(u'orders', 'source')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 15, 20, 20, 49, 427003)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 15, 20, 20, 49, 426850)'}),
