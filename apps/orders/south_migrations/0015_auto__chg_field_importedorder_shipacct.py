...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.shipacct'
        db.alter_column('orders_importedorder', 'shipacct', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.shipacct'
        db.alter_column('orders_importedorder', 'shipacct', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 18, 54, 50, 380411)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 18, 54, 50, 380215)'}),
