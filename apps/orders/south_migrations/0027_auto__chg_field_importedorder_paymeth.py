...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.paymeth'
        db.alter_column('orders_importedorder', 'paymeth', self.gf('django.db.models.fields.CharField')(max_length=12))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.paymeth'
        db.alter_column('orders_importedorder', 'paymeth', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 20, 13, 35, 19, 578364)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 20, 13, 35, 19, 578170)'}),
