...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.shipper'
        db.alter_column('orders_importedorder', 'shipper', self.gf('django.db.models.fields.CharField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.shipper'
        db.alter_column('orders_importedorder', 'shipper', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 20, 2, 51, 694112)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 20, 2, 51, 693928)'}),
