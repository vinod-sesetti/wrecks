...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImportedOrderLine'
        db.create_table('orders_importedorderline', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ImportedOrder'])),
            ...
            ('totprice', self.gf('django.db.models.fields.FloatField')()),
            ('notes', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('shipper', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('shipdate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('shipprice', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('tracknum', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('serial', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('serials', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('details', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('orders', ['ImportedOrderLine'])


    def backwards(self, orm):
        
        # Deleting model 'ImportedOrderLine'
        db.delete_table('orders_importedorderline')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 10, 8, 47, 731)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 10, 8, 47, 580)'}),
        ...
        'customers.customer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'org': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
        ...
        'orders.importedorder': {
            ...
            'billaddr1': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            ...
            'refsrc': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'orders.importedorderline': {
            ...
            'serials': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'shipdate': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
