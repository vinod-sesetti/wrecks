...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.billaddr1'
        db.alter_column('orders_importedorder', 'billaddr1', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'ImportedOrder.shipaddr1'
        db.alter_column('orders_importedorder', 'shipaddr1', self.gf('django.db.models.fields.CharField')(max_length=80))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.billaddr1'
        db.alter_column('orders_importedorder', 'billaddr1', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'ImportedOrder.shipaddr1'
        db.alter_column('orders_importedorder', 'shipaddr1', self.gf('django.db.models.fields.CharField')(max_length=60))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 19, 56, 58, 716600)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 19, 56, 58, 716400)'}),
        ...
        'orders.importedorder': {
            ...
            'refsrc': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
