...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.ccauthnum'
        db.alter_column('orders_importedorder', 'ccauthnum', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ImportedOrder.cc_charged_date'
        db.alter_column('orders_importedorder', 'cc_charged_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ImportedOrder.ccyear'
        db.alter_column('orders_importedorder', 'ccyear', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ImportedOrder.cc_corp_pin'
        db.alter_column('orders_importedorder', 'cc_corp_pin', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ImportedOrder.ccauthnum'
        raise RuntimeError("Cannot reverse this migration. 'ImportedOrder.ccauthnum' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ImportedOrder.cc_charged_date'
        raise RuntimeError("Cannot reverse this migration. 'ImportedOrder.cc_charged_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ImportedOrder.ccyear'
        raise RuntimeError("Cannot reverse this migration. 'ImportedOrder.ccyear' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ImportedOrder.cc_corp_pin'
        raise RuntimeError("Cannot reverse this migration. 'ImportedOrder.cc_corp_pin' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 13, 34, 46, 944591)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 13, 34, 46, 944281)'}),
