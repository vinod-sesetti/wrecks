...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.orderstatus'
        db.alter_column('orders_importedorder', 'orderstatus', self.gf('django.db.models.fields.CharField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.orderstatus'
        db.alter_column('orders_importedorder', 'orderstatus', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 20, 11, 19, 2, 213500)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 20, 11, 19, 2, 213252)'}),
        ...
        'orders.importedorder': {
            ...
            'taxcounty': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
