...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.shipprice'
        db.alter_column('orders_importedorder', 'shipprice', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'ImportedOrder.salestax'
        db.alter_column('orders_importedorder', 'salestax', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'ImportedOrder.costofgoods'
        db.alter_column('orders_importedorder', 'costofgoods', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'ImportedOrder.shiprate'
        db.alter_column('orders_importedorder', 'shiprate', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'ImportedOrder.taxrate'
        db.alter_column('orders_importedorder', 'taxrate', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'ImportedOrder.shipincl'
        db.alter_column('orders_importedorder', 'shipincl', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'ImportedOrder.adjustamt'
        db.alter_column('orders_importedorder', 'adjustamt', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.shipprice'
        db.alter_column('orders_importedorder', 'shipprice', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ImportedOrder.salestax'
        db.alter_column('orders_importedorder', 'salestax', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ImportedOrder.costofgoods'
        db.alter_column('orders_importedorder', 'costofgoods', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ImportedOrder.shiprate'
        db.alter_column('orders_importedorder', 'shiprate', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ImportedOrder.taxrate'
        db.alter_column('orders_importedorder', 'taxrate', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ImportedOrder.shipincl'
        db.alter_column('orders_importedorder', 'shipincl', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'ImportedOrder.adjustamt'
        db.alter_column('orders_importedorder', 'adjustamt', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 13, 24, 4, 440619)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 13, 24, 4, 440430)'}),
