...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.shipcountry'
        db.alter_column('orders_importedorder', 'shipcountry', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.shipcountry'
        db.alter_column('orders_importedorder', 'shipcountry', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 16, 20, 19, 193298)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 16, 20, 19, 192975)'}),
        ...
        'orders.importedorder': {
            ...
            'shipcountry': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
