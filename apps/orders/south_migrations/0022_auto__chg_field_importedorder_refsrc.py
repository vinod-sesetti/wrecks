...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.refsrc'
        db.alter_column('orders_importedorder', 'refsrc', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.refsrc'
        db.alter_column('orders_importedorder', 'refsrc', self.gf('django.db.models.fields.CharField')(max_length=80))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 21, 48, 39, 577590)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 21, 48, 39, 577395)'}),
