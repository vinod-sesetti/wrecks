...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.ccmonth'
        db.alter_column('orders_importedorder', 'ccmonth', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ImportedOrder.ccmonth'
        raise RuntimeError("Cannot reverse this migration. 'ImportedOrder.ccmonth' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 13, 33, 39, 799411)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 13, 33, 39, 799208)'}),
        ...
        'orders.importedorder': {
            ...
            'cc_charged_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'cc_corp_pin': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            ...
            'ccauthnum': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            ...
            'ccyear': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
