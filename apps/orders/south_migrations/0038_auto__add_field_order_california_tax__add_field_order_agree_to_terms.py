...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.california_tax'
        db.add_column(u'orders', 'california_tax', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catax.Catax'], null=True, blank=True), keep_default=False)

        # Adding field 'Order.agree_to_terms'
        db.add_column(u'orders', 'agree_to_terms', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.california_tax'
        db.delete_column(u'orders', 'california_tax_id')

        # Deleting field 'Order.agree_to_terms'
        db.delete_column(u'orders', 'agree_to_terms')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 25, 12, 54, 0, 472916)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 25, 12, 54, 0, 472765)'}),
        ...
        'orders.order': {
            ...
            'agree_to_terms': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'bill_to_address': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'order_bill_to'", 'to': "orm['customers.Address']"}),
            'california_tax': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catax.Catax']", 'null': 'True', 'blank': 'True'}),
