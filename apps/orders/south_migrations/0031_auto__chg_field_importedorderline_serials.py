...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrderLine.serials'
        db.alter_column('orders_importedorderline', 'serials', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'ImportedOrderLine.serials'
        db.alter_column('orders_importedorderline', 'serials', self.gf('django.db.models.fields.CharField')(max_length=250))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 12, 37, 15, 856862)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 12, 37, 15, 856716)'}),
