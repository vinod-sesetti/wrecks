...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedOrder.taxcounty'
        db.alter_column('orders_importedorder', 'taxcounty', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'ImportedOrder.taxcounty'
        db.alter_column('orders_importedorder', 'taxcounty', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 21, 35, 58, 269335)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 21, 35, 58, 269000)'}),
        ...
        'orders.importedorder': {
            ...
            'refsrc': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
