...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.ship_to_address'
        db.add_column(u'orders', 'ship_to_address', self.gf('django.db.models.fields.related.ForeignKey')(default=54290, related_name='order_ship_to', to=orm['customers.Address']), keep_default=False)

        # Adding field 'Order.bill_to_address'
        db.add_column(u'orders', 'bill_to_address', self.gf('django.db.models.fields.related.ForeignKey')(default=54290, related_name='order_bill_to', to=orm['customers.Address']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.ship_to_address'
        db.delete_column(u'orders', 'ship_to_address_id')

        # Deleting field 'Order.bill_to_address'
        db.delete_column(u'orders', 'bill_to_address_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 10, 18, 24, 50, 460866)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 10, 18, 24, 50, 460716)'}),
