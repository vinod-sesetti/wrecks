...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column (u'customers', 'organization_name', 'org')

        # Deleting field 'Customer.organization_name'
        #db.delete_column(u'customers', 'organization_name')

        db.rename_column(u'customers', 'department', 'dept')

        # Deleting field 'Customer.department'
        #db.delete_column(u'customers', 'department')

        # Adding field 'Customer.org'
        #db.add_column(u'customers', 'org', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)
        ...
        # Adding field 'Customer.published'
        db.add_column(u'customers', 'published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        db.rename_column (u'customers', 'org', 'organization_name')

        # Adding field 'Customer.organization_name'
        #db.add_column(u'customers', 'organization_name', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)
        ...
        # Deleting field 'Customer.org'
        #db.delete_column(u'customers', 'org')

        # Deleting field 'Customer.dept'
        #db.delete_column(u'customers', 'dept')

        # Deleting field 'Customer.published'
        db.delete_column(u'customers', 'published')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 16, 18, 2, 47, 861852)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 16, 18, 2, 47, 861704)'}),
