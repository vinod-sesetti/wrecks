...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('customers_addresses')

        # Adding model 'Address'
        db.create_table('customers_address', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('org', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('address1', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('address2', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ...
        db.send_create_signal('customers', ['Address'])


    def backwards(self, orm):
        
        # Adding model 'Addresses'
        db.create_table('customers_addresses', (
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer'])),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ...
        db.send_create_signal('customers', ['Addresses'])

        # Deleting model 'Address'
        db.delete_table('customers_address')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 16, 19, 14, 13, 306381)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 16, 19, 14, 13, 306182)'}),
        ...
        'customers.address': {
            ...
            'address2': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            ...
            'org': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
