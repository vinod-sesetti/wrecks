...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('customers_customerimage', 'image', self.gf('filebrowser.fields.FileBrowseField')(default='', max_length=200))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 22, 2, 16, 6, 303024)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 22, 2, 16, 6, 302839)'}),
