...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CustomerImage.image2'
        db.delete_column('customers_customerimage', 'image2_id')


    def backwards(self, orm):
        
        # Adding field 'CustomerImage.image2'
        db.add_column('customers_customerimage', 'image2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 19, 1, 0, 691010)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 19, 1, 0, 690832)'}),
