...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.default_shipping'
        db.add_column(u'customers', 'default_shipping', self.gf('django.db.models.fields.related.ForeignKey')(default=54290, related_name='customer_default_shipping', to=orm['customers.Address']), keep_default=False)

        # Adding field 'Customer.default_billing'
        db.add_column(u'customers', 'default_billing', self.gf('django.db.models.fields.related.ForeignKey')(default=54290, related_name='customer_default_billing', to=orm['customers.Address']), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 10, 18, 23, 40, 491380)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 10, 18, 23, 40, 491229)'}),
