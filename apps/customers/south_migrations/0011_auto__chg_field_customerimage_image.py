...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerImage.image'
        db.alter_column('customers_customerimage', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'CustomerImage.image'
        raise RuntimeError("Cannot reverse this migration. 'CustomerImage.image' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 23, 28, 13, 54385)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 23, 28, 13, 54203)'}),
