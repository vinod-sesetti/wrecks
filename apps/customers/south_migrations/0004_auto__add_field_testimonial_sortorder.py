...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Testimonial.sortorder'
        db.add_column('customers_testimonial', 'sortorder', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Testimonial.sortorder'
        db.delete_column('customers_testimonial', 'sortorder')
