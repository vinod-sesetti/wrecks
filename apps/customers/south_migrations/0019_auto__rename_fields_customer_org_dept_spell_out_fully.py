...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column (u'customers', 'org', 'organization')

    def backwards(self, orm):
        db.rename_column(u'customers', 'department', 'dept')
        db.rename_column (u'customers', 'organization', 'org')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 12, 16, 59, 296693)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 12, 16, 59, 296546)'}),
        ...
        'customers.customer': {
            ...
            'deptartment': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
