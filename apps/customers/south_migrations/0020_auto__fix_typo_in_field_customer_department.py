...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'customers', 'deptartment', 'department')

    def backwards(self, orm):
        db.rename_column(u'customers', 'department', 'deptartment')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 12, 24, 32, 457029)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 12, 24, 32, 456882)'}),
