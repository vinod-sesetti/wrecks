...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomerImage.sortorder'
        db.add_column('customers_customerimage', 'sortorder', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomerImage.sortorder'
        db.delete_column('customers_customerimage', 'sortorder')
