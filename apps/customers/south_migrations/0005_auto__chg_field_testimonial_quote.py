...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Testimonial.quote'
        db.alter_column('customers_testimonial', 'quote', self.gf('django.db.models.fields.TextField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Testimonial.quote'
        db.alter_column('customers_testimonial', 'quote', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'customers.testimonial': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'quote': ('django.db.models.fields.TextField', [], {'max_length': '100'}),
            'sortorder': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        }
    }
