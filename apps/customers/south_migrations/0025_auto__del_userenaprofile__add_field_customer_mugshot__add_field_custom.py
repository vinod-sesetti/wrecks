...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'UserenaProfile'
        db.delete_table('customers_userenaprofile')

        # Adding field 'Customer.mugshot'
        db.add_column(u'customers', 'mugshot', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Customer.privacy'
        db.add_column(u'customers', 'privacy', self.gf('django.db.models.fields.CharField')(default='closed', max_length=15), keep_default=False)

        # Changing field 'Customer.user'
        db.alter_column(u'customers', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=2, to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'Customer', fields ['user']
        db.create_unique(u'customers', ['user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Customer', fields ['user']
        db.delete_unique(u'customers', ['user_id'])

        # Adding model 'UserenaProfile'
        db.create_table('customers_userenaprofile', (
        ...
        db.send_create_signal('customers', ['UserenaProfile'])

        # Deleting field 'Customer.mugshot'
        db.delete_column(u'customers', 'mugshot')

        # Deleting field 'Customer.privacy'
        db.delete_column(u'customers', 'privacy')

        # Changing field 'Customer.user'
        db.alter_column(u'customers', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 13, 57, 25, 703175)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 13, 57, 25, 703026)'}),
