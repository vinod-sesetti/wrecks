...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'customers_address', 'org', 'organization')
        # Deleting field 'Address.org'
        #db.delete_column('customers_address', 'org')
    ...
    def backwards(self, orm):
        db.rename_column(u'customers_address', 'organization', 'org')

        # Adding field 'Address.org'
        #db.add_column('customers_address', 'org', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 22, 22, 0, 46, 411675)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 22, 22, 0, 46, 411527)'}),
