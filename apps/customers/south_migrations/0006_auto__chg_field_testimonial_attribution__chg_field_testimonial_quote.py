...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Testimonial.attribution'
        db.alter_column('customers_testimonial', 'attribution', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Testimonial.quote'
        db.alter_column('customers_testimonial', 'quote', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Testimonial.attribution'
        db.alter_column('customers_testimonial', 'attribution', self.gf('django.db.models.fields.CharField')(max_length=100))
