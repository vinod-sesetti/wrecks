...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeaturedImage.image'
        db.alter_column('home_featuredimage', 'image', self.gf('filebrowser.fields.FileBrowseField')(default='', max_length=200))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FeaturedImage.image'
        db.alter_column('home_featuredimage', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True))
