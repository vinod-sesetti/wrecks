...
import mymodules   # note - this has to be in 3 places - work dir, <zope>Extensions, <zope>root (lib/python/Shared doesn't work) - yuk
from myutil import *
...
pix  = '<img src="%s/images/pix.gif" height="1" width="1" border="0">' % mymodules.rootpath
pix2 = '<img src="%s/images/pix.gif" height="2" width="2" border="0">' % mymodules.rootpath
...
def configgrid (self):
  ...
  noteslab = 'Notes'
  textarea = '<font face="arial,helvetica,sans-serif" size="2"><textarea rows="2" cols="60" name="notes">%s</textarea></font>' % notes
