...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Choice.blurb'
        db.add_column(u'choices', 'blurb', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        db.delete_column(u'choices', 'blurb')
