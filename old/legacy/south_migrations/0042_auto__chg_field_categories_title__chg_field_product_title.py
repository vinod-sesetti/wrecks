...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Categories.title'
        db.alter_column(u'categories', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Product.title'
        db.alter_column(u'products', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Categories.title'
        db.alter_column(u'categories', 'title', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Product.title'
        db.alter_column(u'products', 'title', self.gf('django.db.models.fields.CharField')(max_length=70))
    ...
    models = {
        ...
        'legacy.categories': {
            ...
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['legacy.Image']", 'symmetrical': 'False', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
