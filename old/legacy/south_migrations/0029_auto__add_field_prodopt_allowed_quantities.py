...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prodopt.allowed_quantities'
        db.add_column(u'prodopts', 'allowed_quantities', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=80, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Prodopt.allowed_quantities'
        db.delete_column(u'prodopts', 'allowed_quantities')
