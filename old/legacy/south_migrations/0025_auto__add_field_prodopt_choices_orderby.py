...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prodopt.choices_orderby'
        db.add_column(u'prodopts', 'choices_orderby', self.gf('django.db.models.fields.CharField')(default='cost', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Prodopt.choices_orderby'
        db.delete_column(u'prodopts', 'choices_orderby')
