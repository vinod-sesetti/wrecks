...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prodoptchoice.created'
        db.add_column(u'prodoptchoices', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 7, 9), blank=True), keep_default=False)

        # Adding field 'Prodoptchoice.updated'
        db.add_column(u'prodoptchoices', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 7, 9), blank=True), keep_default=False)

        # Adding field 'Prodopt.created'
        db.add_column(u'prodopts', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 7, 9), blank=True), keep_default=False)

        # Adding field 'Prodopt.updated'
        db.add_column(u'prodopts', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 7, 9), blank=True), keep_default=False)

        # MUST MANUALLY SET DATES IN SQL - see sql fixture examples, or run them here :)

    def backwards(self, orm):

        # Deleting field 'Prodoptchoice.created'
        db.delete_column(u'prodoptchoices', 'created')

        # Deleting field 'Prodoptchoice.updated'
        db.delete_column(u'prodoptchoices', 'updated')

        # Deleting field 'Prodopt.created'
        db.delete_column(u'prodopts', 'created')

        # Deleting field 'Prodopt.updated'
        db.delete_column(u'prodopts', 'updated')
