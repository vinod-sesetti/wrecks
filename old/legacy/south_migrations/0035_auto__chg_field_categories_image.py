...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Categories.image'
        db.alter_column(u'categories', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Categories.image'
        db.alter_column(u'categories', 'image', self.gf('django.db.models.fields.CharField')(max_length=300))
