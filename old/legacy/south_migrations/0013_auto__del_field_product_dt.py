...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.dt'
        db.delete_column(u'products', 'dt')


    def backwards(self, orm):

        # Adding field 'Product.dt'
        db.add_column(u'products', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 7, 9), blank=True), keep_default=False)
