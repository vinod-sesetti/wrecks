...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'products', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 7, 9), blank=True), keep_default=False)

        # Adding field 'Product.updated'
        db.add_column(u'products', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 7, 9), blank=True), keep_default=False)

        from apps.legacy.models import Product

        for prod in Product.objects.all():
            prod.created = prod.dt
            prod.updated = prod.dt
            prod.save()

    def backwards(self, orm):

        # Deleting field 'Product.created'
        db.delete_column(u'products', 'created')

        # Deleting field 'Product.updated'
        db.delete_column(u'products', 'updated')
