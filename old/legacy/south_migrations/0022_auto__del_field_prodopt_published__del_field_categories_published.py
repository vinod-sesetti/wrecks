...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'prodopts', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Categories.published'
        db.add_column(u'categories', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
