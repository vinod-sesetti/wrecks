...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'choices', 'current', self.gf('django.db.models.fields.BooleanField')())

        # NOTE: this won't work, special postgres sql is required, see: 
        # alter_current_to_boolean.sql
