...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Choice.dt'
        db.delete_column(u'choices', 'dt')


    def backwards(self, orm):
        
        # Adding field 'Choice.dt'
        db.add_column(u'choices', 'dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 7, 9)), keep_default=False)
