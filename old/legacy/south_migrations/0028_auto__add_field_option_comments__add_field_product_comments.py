...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Option.comments'
        db.add_column(u'options', 'comments', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Product.comments'
        db.add_column(u'products', 'comments', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Option.comments'
        db.delete_column(u'options', 'comments')

        # Deleting field 'Product.comments'
        db.delete_column(u'products', 'comments')
