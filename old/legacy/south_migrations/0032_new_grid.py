...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.new_grid'
        db.add_column(u'products', 'new_grid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Product.new_grid'
        db.delete_column(u'products', 'new_grid')
