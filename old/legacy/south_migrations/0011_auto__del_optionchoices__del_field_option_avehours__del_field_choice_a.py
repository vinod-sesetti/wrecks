...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Option.avehours'
        db.delete_column(u'options', 'avehours')

        # Deleting field 'Choice.avehours'
        db.delete_column(u'choices', 'avehours')

        # Deleting field 'Choice.current'
        #db.delete_column(u'choices', 'current')

        # Adding field 'Choice.published'
        #db.add_column(u'choices', 'published', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Option.avehours'
        db.add_column(u'options', 'avehours', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Choice.avehours'
        db.add_column(u'choices', 'avehours', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Choice.current'
        #db.add_column(u'choices', 'current', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Choice.published'
        #db.delete_column(u'choices', 'published')
