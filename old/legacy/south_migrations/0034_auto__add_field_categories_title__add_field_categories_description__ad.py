...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Categories.title'
        db.add_column(u'categories', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=70, blank=True), keep_default=False)

        # Adding field 'Categories.description'
        db.add_column(u'categories', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Categories.comments'
        db.add_column(u'categories', 'comments', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Categories.image'
        db.add_column(u'categories', 'image', self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True), keep_default=False)

        # Adding field 'Categories.sortorder'
        db.add_column(u'categories', 'sortorder', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Categories.title'
        db.delete_column(u'categories', 'title')

        # Deleting field 'Categories.description'
        db.delete_column(u'categories', 'description')

        # Deleting field 'Categories.comments'
        db.delete_column(u'categories', 'comments')

        # Deleting field 'Categories.image'
        db.delete_column(u'categories', 'image')

        # Deleting field 'Categories.sortorder'
        db.delete_column(u'categories', 'sortorder')
