...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Option.usage_notes'
        db.add_column(u'options', 'usage_notes', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Option.usage_notes'
        db.delete_column(u'options', 'usage_notes')
