...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Prodoptchoice.dt'
        db.delete_column(u'prodoptchoices', 'dt')

        # Deleting field 'Prodopt.dt'
        db.delete_column(u'prodopts', 'dt')


    def backwards(self, orm):
        
        # Adding field 'Prodoptchoice.dt'
        db.add_column(u'prodoptchoices', 'dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 7, 9)), keep_default=False)

        # Adding field 'Prodopt.dt'
        db.add_column(u'prodopts', 'dt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 7, 9)), keep_default=False)
