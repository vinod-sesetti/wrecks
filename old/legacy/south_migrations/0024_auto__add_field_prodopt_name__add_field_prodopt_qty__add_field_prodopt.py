...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prodopt.name'
        db.add_column(u'prodopts', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'Prodopt.qty'
        db.add_column(u'prodopts', 'qty', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Prodopt.single'
        db.add_column(u'prodopts', 'single', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Prodopt.required'
        db.add_column(u'prodopts', 'required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Prodopt.name'
        db.delete_column(u'prodopts', 'name')

        # Deleting field 'Prodopt.qty'
        db.delete_column(u'prodopts', 'qty')

        # Deleting field 'Prodopt.single'
        db.delete_column(u'prodopts', 'single')

        # Deleting field 'Prodopt.required'
        db.delete_column(u'prodopts', 'required')
