...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.pix'
        db.delete_column(u'products', 'pix')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Product.pix'
        db.add_column(u'products', 'pix', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)
