...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cacountytax.county'
        db.alter_column(u'cacountytax', 'county', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Cacountytax.city'
        db.alter_column(u'cacountytax', 'city', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Prodoptchoice.current'
        db.alter_column(u'prodoptchoices', 'current', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Prodoptchoice.dt'
        db.alter_column(u'prodoptchoices', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Prodoptchoice.id'
        db.alter_column(u'prodoptchoices', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Cacounties.county'
        db.alter_column(u'cacounties', 'county', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Cacounties.city'
        db.alter_column(u'cacounties', 'city', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Prodopt.id'
        db.alter_column(u'prodopts', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Prodopt.dt'
        db.alter_column(u'prodopts', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Removing M2M table for field choices on 'prodopt'
        db.delete_table('prodopts_choices')

        # Changing field 'Cacountycounts.county'
        db.alter_column(u'cacountycounts', 'county', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Cacountytaxcounts.county'
        db.alter_column(u'cacountytaxcounts', 'county', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Cacountytaxcounts.city'
        db.alter_column(u'cacountytaxcounts', 'city', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Emails.id'
        db.alter_column(u'emails', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Categories.id'
        db.alter_column(u'categories', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Option.dt'
        db.alter_column(u'options', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Option.id'
        db.alter_column(u'options', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Adding field 'Choice.choicecategory'
        db.add_column(u'choices', 'choicecategory', self.gf('django.db.models.fields.related.ForeignKey')(default=43882, to=orm['legacy.ChoiceCategory']), keep_default=False)

        # Changing field 'Choice.current'
        db.alter_column(u'choices', 'current', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Choice.dt'
        db.alter_column(u'choices', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Choice.id'
        db.alter_column(u'choices', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Product.dt'
        db.alter_column(u'products', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Product.id'
        db.alter_column(u'products', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Removing M2M table for field options on 'product'
        db.delete_table('products_options')

        # Changing field 'Catax.county'
        db.alter_column(u'catax', 'county', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Catax.city'
        db.alter_column(u'catax', 'city', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'customers', (
            ...
            ('dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('email2', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        # Changing field 'Cacountytax.county'
        db.alter_column(u'cacountytax', 'county', self.gf('django.db.models.fields.CharField')(max_length=-1))

        # Changing field 'Cacountytax.city'
        db.alter_column(u'cacountytax', 'city', self.gf('django.db.models.fields.CharField')(max_length=-1))

        # Changing field 'Prodoptchoice.current'
        db.alter_column(u'prodoptchoices', 'current', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Prodoptchoice.dt'
        db.alter_column(u'prodoptchoices', 'dt', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Prodoptchoice.id'
        db.alter_column(u'prodoptchoices', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Cacounties.county'
        db.alter_column(u'cacounties', 'county', self.gf('django.db.models.fields.CharField')(max_length=-1))

        # Changing field 'Cacounties.city'
        db.alter_column(u'cacounties', 'city', self.gf('django.db.models.fields.CharField')(max_length=-1))

        # Changing field 'Prodopt.id'
        db.alter_column(u'prodopts', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Prodopt.dt'
        db.alter_column(u'prodopts', 'dt', self.gf('django.db.models.fields.DateTimeField')())

        # Adding M2M table for field choices on 'prodopt'
        db.create_table(u'prodopts_choices', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prodopt', models.ForeignKey(orm['legacy.prodopt'], null=False)),
            ('choice', models.ForeignKey(orm['legacy.choice'], null=False))
        ))
        db.create_unique(u'prodopts_choices', ['prodopt_id', 'choice_id'])

        # Changing field 'Cacountycounts.county'
        db.alter_column(u'cacountycounts', 'county', self.gf('django.db.models.fields.CharField')(max_length=-1))

        # Changing field 'Cacountytaxcounts.county'
        db.alter_column(u'cacountytaxcounts', 'county', self.gf('django.db.models.fields.CharField')(max_length=-1))

        # Changing field 'Cacountytaxcounts.city'
        db.alter_column(u'cacountytaxcounts', 'city', self.gf('django.db.models.fields.CharField')(max_length=-1))

        # Changing field 'Emails.id'
        db.alter_column(u'emails', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Categories.id'
        db.alter_column(u'categories', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Option.dt'
        db.alter_column(u'options', 'dt', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Option.id'
        db.alter_column(u'options', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Deleting field 'Choice.choicecategory'
        db.delete_column(u'choices', 'choicecategory_id')

        # Changing field 'Choice.current'
        db.alter_column(u'choices', 'current', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Choice.dt'
        db.alter_column(u'choices', 'dt', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Choice.id'
        db.alter_column(u'choices', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Product.dt'
        db.alter_column(u'products', 'dt', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Product.id'
        db.alter_column(u'products', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Adding M2M table for field options on 'product'
        db.create_table(u'products_options', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm['legacy.product'], null=False)),
            ('option', models.ForeignKey(orm['legacy.option'], null=False))
        ))
        db.create_unique(u'products_options', ['product_id', 'option_id'])

        # Changing field 'Catax.county'
        db.alter_column(u'catax', 'county', self.gf('django.db.models.fields.CharField')(max_length=-1))

        # Changing field 'Catax.city'
        db.alter_column(u'catax', 'city', self.gf('django.db.models.fields.CharField')(max_length=-1))
